...
to 'false' disables the GOPATH set-up, SEMMLE_EXTRACTOR_GO_BUILD_COMMAND (or alternatively
...
In resource-constrained environments, the environment variable SEMMLE_EXTRACTOR_GO_MAX_GOROUTINES
...
func main() {
	...
	inst := util.Getenv("SEMMLE_EXTRACTOR_GO_BUILD_COMMAND", "LGTM_INDEX_BUILD_COMMAND")
