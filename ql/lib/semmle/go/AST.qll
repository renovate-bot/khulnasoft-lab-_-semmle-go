...
class AstNode extends @node, Locatable {
  ...
  /**
   * Gets a comma-separated list of the names of the primary Semmle classes to which this element belongs.
   */
  final string getPrimaryQlClasses() { result = concat(getAPrimaryQlClass(), ",") }

  /**
   * Gets the name of a primary Semmle class to which this node belongs.
   *
